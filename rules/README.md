...
| [`antigravity/`](antigravity/) | `.md` | **Antigravity** 专有规则（被脚本聚合注入 `plugin.json`） |
...
4. **Antigravity 专有规则**：编辑 `antigravity/AGENTS.md` 与 `antigravity/agent-rules/*.md`，再运行 `scripts/setup-antigravity-agents.ps1` 将其重新聚合注入。
