...
/// <summary>
/// 进程内组合根（archive）：含 ProjectFileService。
/// </summary>
public static partial class CompositionRoot
{
    ...
    /// <summary>工程文件服务。</summary>
    public static ProjectFileService ProjectFileService =>
        Services.GetRequiredService<ProjectFileService>();
    ...
    private static IServiceProvider Build()
    {
        ...
        c.AddSingleton<ProjectFileService>();
